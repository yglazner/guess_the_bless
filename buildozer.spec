...
# (str) Package name
package.name = guess_the_bless

# (str) Package domain (needed for android/ios packaging)
package.domain = org.glazner.apps.guess.the_bless

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,wav,lvl,ttf
...
#android.permissions = INTERNET, CAMERA, BLUETOOTH
android.permissions = 
